(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))a(r);new MutationObserver(r=>{for(const n of r)if(n.type==="childList")for(const s of n.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&a(s)}).observe(document,{childList:!0,subtree:!0});function c(r){const n={};return r.integrity&&(n.integrity=r.integrity),r.referrerPolicy&&(n.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?n.credentials="include":r.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function a(r){if(r.ep)return;r.ep=!0;const n=c(r);fetch(r.href,n)}})();const _=`<header class="header">\r
...
</footer>`,p=document.createElement("a"),y=()=>{document.querySelector("#download-btn").addEventListener("click",()=>{setTimeout(()=>{p.href="./assets/documents/cv-enero-2024.pdf",p.download="Josue Lopez Frontend DEV",p.click()},3200)}),document.querySelectorAll(".button").forEach(a=>{let r=3e3,n=a.querySelector("svg"),s=new Proxy({y:null,smoothing:null},{set(e,t,l){return e[t]=l,e.y!==null&&e.smoothing!==null&&(n.innerHTML=c(e.y,e.smoothing,null)),!0},get(e,t){return e[t]}});a.style.setProperty("--duration",r),s.y=20,s.smoothing=0,a.addEventListener("click",e=>{a.classList.contains("loading")||(a.classList.add("loading"),gsap.to(s,{smoothing:.3,duration:r*.065/1e3}),gsap.to(s,{y:12,duration:r*.265/1e3,delay:r*.065/1e3,ease:Elastic.easeOut.config(1.12,.4)}),setTimeout(()=>{n.innerHTML=c(0,0,[[3,14],[8,19],[21,6]])},r/2))})});function i(a,r,n,s){let e=(o,u,b,w)=>{let d=u||o,m=b||o,f={length:Math.sqrt(Math.pow(m[0]-d[0],2)+Math.pow(m[1]-d[1],2)),angle:Math.atan2(m[1]-d[1],m[0]-d[0])},v=f.angle+(w?Math.PI:0),h=f.length*s;return[o[0]+Math.cos(v)*h,o[1]+Math.sin(v)*h]},t=e(n[r-1],n[r-2],a,!1),l=e(a,n[r-1],n[r+1],!0);return`C ${t[0]},${t[1]} ${l[0]},${l[1]} ${a[0]},${a[1]}`}function c(a,r,n){return`<path d="${(n||[[4,12],[12,a],[20,12]]).reduce((t,l,o,u)=>o===0?`M ${l[0]},${l[1]}`:`${t} ${i(l,o,u,r)}`,"")}" />`}},j=g=>{(()=>{const i=document.createElement("div");i.innerHTML=_,document.querySelector(g).append(i)})(),y()};j("#app");
