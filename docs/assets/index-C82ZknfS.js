(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))e(r);new MutationObserver(r=>{for(const n of r)if(n.type==="childList")for(const s of n.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&e(s)}).observe(document,{childList:!0,subtree:!0});function d(r){const n={};return r.integrity&&(n.integrity=r.integrity),r.referrerPolicy&&(n.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?n.credentials="include":r.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function e(r){if(r.ep)return;r.ep=!0;const n=d(r);fetch(r.href,n)}})();const _=`<header class="header">\r
...
</footer>`,y=window.matchMedia("(prefers-color-scheme: dark)"),j=c=>{document.documentElement.setAttribute("data-theme",c)};y.matches&&j("dark");const p=document.createElement("a"),k=()=>{document.querySelector("#download-btn").addEventListener("click",()=>{setTimeout(()=>{p.href="./assets/documents/cv-enero-2024.pdf",p.download="Josue Lopez Frontend DEV",p.click()},3200)}),document.querySelectorAll(".button").forEach(e=>{let r=3e3,n=e.querySelector("svg"),s=new Proxy({y:null,smoothing:null},{set(a,t,l){return a[t]=l,a.y!==null&&a.smoothing!==null&&(n.innerHTML=d(a.y,a.smoothing,null)),!0},get(a,t){return a[t]}});e.style.setProperty("--duration",r),s.y=20,s.smoothing=0,e.addEventListener("click",a=>{e.classList.contains("loading")||(e.classList.add("loading"),gsap.to(s,{smoothing:.3,duration:r*.065/1e3}),gsap.to(s,{y:12,duration:r*.265/1e3,delay:r*.065/1e3,ease:Elastic.easeOut.config(1.12,.4)}),setTimeout(()=>{n.innerHTML=d(0,0,[[3,14],[8,19],[21,6]])},r/2))})});function i(e,r,n,s){let a=(o,u,b,w)=>{let m=u||o,g=b||o,f={length:Math.sqrt(Math.pow(g[0]-m[0],2)+Math.pow(g[1]-m[1],2)),angle:Math.atan2(g[1]-m[1],g[0]-m[0])},h=f.angle+(w?Math.PI:0),v=f.length*s;return[o[0]+Math.cos(h)*v,o[1]+Math.sin(h)*v]},t=a(n[r-1],n[r-2],e,!1),l=a(e,n[r-1],n[r+1],!0);return`C ${t[0]},${t[1]} ${l[0]},${l[1]} ${e[0]},${e[1]}`}function d(e,r,n){return`<path d="${(n||[[4,12],[12,e],[20,12]]).reduce((t,l,o,u)=>o===0?`M ${l[0]},${l[1]}`:`${t} ${i(l,o,u,r)}`,"")}" />`}},L=c=>{(()=>{const i=document.createElement("div");i.innerHTML=_,document.querySelector(c).append(i)})(),k()};L("#app");
